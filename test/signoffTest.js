...
describe('case sign-off tracking', () => {
  ...
  describe('case + archive operations', () => {
    /* GRACE FIX THIS
    it('it should retrieve a sign-off entry for a given case identifier', (done) => {
    ...
    */
    it('it should add to retrieve an sign-off entry is found', (done) => {
      let reqBody = {
        caseIdentifier: 'R22_TEST_0022_Bb_B',
        qc_passed: true,
        username: 'testuser',
        signoff_step_name: 'RUO',
        deliverable_type: 'QC Gate 1',
      };
